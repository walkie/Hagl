...
-- | Payoffs are represented as a list of `Float` values where each value
--   corresponds to a particular player. While the type of payoffs could be
--   generalized, this representation supports both cardinal and ordinal
--   payoffs while being easy to work with.
...
-- | Payoff where all players out of n score payoff a, except player p,
--   who scores b.
